package com.example.sample_processor
...
import com.example.sample_annotation.model.FieldNameAndTag
import com.example.sample_annotation.model.ValidationResult
...
class Processor : AbstractProcessor() {
    ...
    companion object {
        ...
        val fileBuilder =
            FileSpec.builder("com.gyeongmun.generated", "DataValidationExtension")
    }
    ...
    override fun process(
        ...
        roundEnv?.getElementsAnnotatedWith(DataValidation::class.java)?.let { classElements ->
